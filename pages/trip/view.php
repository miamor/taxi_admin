...
<!--    <div class="form-group">
        ...
        <div class="col-lg-9">
            <script>​document.getElementById('userid').value = <?php echo $trip->userid ?>;</script>
            <select id="userid" class="chosen-select form-control" name="userid">
                <option value="">NULL</option>
            <?php foreach ($user->all_list as $oneU) {
                $isChecked = ($oneU['id'] == $trip->userid) ? 'checked' : '';
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="hidden" readonly class="form-control" name="id" value="<?php echo $trip->id ?>"/>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" name="phone" value="<?php echo $trip->phone ?>"/>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" name="from" value="<?php echo $trip->addressfrom ?>"/>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" name="to" value="<?php echo $trip->addressto ?>"/>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="number" min="1" class="form-control" name="num_guess" value="<?php echo $trip->num_guess ?>"/>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" name="time" value="<?php echo $trip->time ?>"/>
        </div>
<!--        <div class="col-lg-5">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <label class="radio">
                <input type="radio" name="is_round" <?php if ($trip->is_round == 0) echo 'checked' ?> value="0"/> Một chiều
            </label>
            <label class="radio">
                <input type="radio" name="is_round" <?php if ($trip->is_round == 1) echo 'checked' ?> value="1"/> Hai chiều
            </label>
        </div>
        <div class="clearfix"></div>
    </div>
